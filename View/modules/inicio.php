	...
	<div class="logo-w3layouts">
		<div class="header-top-w3ls">
			<div class="container">
				...
				<div class="right-p">
					<ul>
						<li>
							<span class="fa fa-phone" aria-hidden="true"></span>971-223-79</li>
						<li>
							<span class="fa fa-clock-o" aria-hidden="true"></span>( Lunes-Viernes 9am - 8pm ) ( Sabados 10am - 4pm )</li>
					</ul>
				</div>
		...
		<div class="header-mid">
			<div class="container">
				<h1>
					<a href="index.html">
						<span>C</span>onsultorio
						<span>D</span>ental
						<span>C</span>omitancillo</a>
				</h1>
						...
						<nav class="navbar navbar-default">
							...
							<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
								<ul class="nav navbar-nav navbar-right">
									<li>
										<a href="index.html" class="active scroll">Inicio</a>
									</li>
									
									<li>
										<a href="#team" class="scroll">Nuestros Doctores</a>
									</li>
									<li>
									...
									<li>
										<a href="AdminLTE-3.0.0/login" class="scroll">Login</a>
									</li>
								</ul>
							</div>
							<div class="clearfix"> </div>
				...
				<ul class="rslides" id="slider3">
					...
					<li>
						<div class="slider-img b2">
							<img src="View/images/b2.jpg" alt=" " class="img-responsive" />
	...
	<div class="bnr-btm-w3layouts" id="appoint">
		<div class="bnr-lft-agileits">
			<h2>¡Registre sus datos y pide una cita!</h2>
			<p class="para-agileits-w3layouts">Solo haga una cita para obtener ayuda de nuestros expertos.</p>
			<h3 class="subheading-agileits-w3layouts">Nuestros Servicios</h3>
			<ul>
				<li>
					<span class="fa fa-stethoscope" aria-hidden="true"></span>Blanqueamiento dental</li>
				<li>
					<span class="fa fa-user-md" aria-hidden="true"></span>Muelas del juicio</li>
				<li>
					<span class="fa fa-stethoscope" aria-hidden="true"></span>Coronillas</li>
				<li>
					<span class="fa fa-user-md" aria-hidden="true"></span>  Implantes dentales</li>
				<li>
					<span class="fa fa-stethoscope" aria-hidden="true"></span>Endodoncista</li>
				<li>
					<span class="fa fa-user-md" aria-hidden="true"></span>Cirugias</li>
		...
		<div class="bnr-rgt-w3-agile">
			<form method="post">
				...
				<center><a href="AdminLTE-3.0.0/login" class=""></a></center>	
				</div>
			</form>
		</div>
	</div>
	...
	<div class="about-w3layouts" id="about">
		<div class="container">
			<div class="tittle-agileinfo">
				<h5 class="title-w3">Nuestra pagina</h5>
				<div class="about-top">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<img src="View/images/b1.jpg" alt=" " class="img-responsive" />
	...
	<div class="gallery-w3layouts" id="portfolio">
		<div class="container-fluid">
			...
			<div class="col-md-3 gallery-columns">
				<div class="gal_grid_outer">
					<a title="We’re pleased to offer a wide range of dental services."
					    href="View/images/g1.jpg">
						<div class="gal_grid_outer1">
							<img src="View/images/g1.jpg" alt=" " class="img-responsive" />
				...
				<div class="gal_grid_outer">
					<a title="We’re pleased to offer a wide range of dental services."
					    href="View/images/g2.jpg">
						<div class="gal_grid_outer1">
							<img src="View/images/g2.jpg" alt=" " class="img-responsive" />
							<div class="gallery_grid_pos">
								<h3>
									<span>P</span>early
									<span>C</span>are</h3>
			...
			<div class="col-md-3 gallery-columns">
				<div class="gal_grid_outer">
					<a title="We’re pleased to offer a wide range of dental services."
					    href="View/images/g4.jpg">
						<div class="gal_grid_outer1">
							<img src="View/images/g4.jpg" alt=" " class="img-responsive" />
							<div class="gallery_grid_pos">
								<h3>
									<span>P</span>early
									<span>C</span>are</h3>
				...
				<div class="gal_grid_outer">
					<a title="We’re pleased to offer a wide range of dental services."
					    href="View/images/g5.jpg">
						<div class="gal_grid_outer1">
							<img src="View/images/g5.jpg" alt=" " class="img-responsive" />
							<div class="gallery_grid_pos">
								<h3>
									<span>P</span>early
									<span>C</span>are</h3>
			...
			<div class="col-md-3 gallery-columns">
				<div class="gal_grid_outer">
					<a title="We’re pleased to offer a wide range of dental services."
					    href="View/images/g7.jpg">
						<div class="gal_grid_outer1">
							<img src="View/images/g7.jpg" alt=" " class="img-responsive" />
							<div class="gallery_grid_pos">
								<h3>
									<span>P</span>early
									<span>C</span>are</h3>
				...
				<div class="gal_grid_outer">
					<a title="We’re pleased to offer a wide range of dental services."
					    href="View/images/g8.jpg">
						<div class="gal_grid_outer1">
							<img src="View/images/g8.jpg" alt=" " class="img-responsive" />
							<div class="gallery_grid_pos">
								<h3>
									<span>P</span>early
									<span>C</span>are</h3>
			...
			<div class="col-md-3 gallery-columns">
				<div class="gal_grid_outer">
					<a title="We’re pleased to offer a wide range of dental services."
					    href="View/images/g6.jpg">
						<div class="gal_grid_outer1">
							<img src="View/images/g6.jpg" alt=" " class="img-responsive" />
							<div class="gallery_grid_pos">
								<h3>
									<span>P</span>early
									<span>C</span>are</h3>
				...
				<div class="gal_grid_outer">
					<a title="We’re pleased to offer a wide range of dental services."
					    href="View/images/g3.jpg">
						<div class="gal_grid_outer1">
							<img src="View/images/g3.jpg" alt=" " class="img-responsive" />
							<div class="gallery_grid_pos">
								<h3>
									<span>P</span>early
									<span>C</span>are</h3>
		...
		<div class="container">
			...
			<div class="team-w3ls">
				<div class="col-md-3 team-grid w3_agileits">
					<img class="img-w3l t1-wthree img-responsive" src="View/images/t1.jpg" alt="">
					<h6>Andrew Bert</h6>
				...
				<div class="col-md-3 team-grid w3_agileits t2">
					<img class="img-w3l t1-wthree img-responsive" src="View/images/t2.jpg" alt="">
					<h6>Mecan smith</h6>
					<p>Lorem ipsum dolor sit amet. Cras rutrum iaculis enim, non convallis felis mattis.</p>
					<div class="w3l-social">
						<ul>
				...
				<div class="col-md-3 w3_agileits team-grid">
					<img class="img-w3l t1-wthree img-responsive" src="View/images/t4.jpg" alt="">
					<h6>Jack Bravo</h6>
					<p>Lorem ipsum dolor sit amet. Cras rutrum iaculis enim, non convallis felis mattis.</p>
					<div class="w3l-social">
						<ul>
				...
				<div class="col-md-3 w3_agileits team-grid">
					<img class="img-w3l t1-wthree img-responsive" src="View/images/t3.jpg" alt="">
					<h6>Bernard Smith</h6>
					<p>Lorem ipsum dolor sit amet. Cras rutrum iaculis enim, non convallis felis mattis.</p>
					<div class="w3l-social">
						<ul>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h2 class="modal-title" id="exampleModalLabel">L O G I N</h2>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="bnr-rgt-w3-agile">
			<form  method="post">
				...
				<div class="inputs-w3ls two">
         		...
         		<!--		<div class="inputs-w3ls two">
					<input id="datepicker" name="Text" type="text" placeholder="Fecha de nacimiento" value="" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'mm/dd/yyyy';}"
					    required="">
				</div> -->
...
if(isset($_GET["action"])){
	if($_GET["action"] == "okUser"){
    	  echo '<script>alert("Datos registrados correctamente.");</script>';
		  echo '<script> window.location="inicio";</script>';
    }	
    elseif($_GET["action"] == "errorUser"){
    	  echo '<script>alert("No se pudo enviar los datos, intente nuevamente por favor.");</script>';
		  echo '<script> window.location="inicio";</script>';
    }
 }
